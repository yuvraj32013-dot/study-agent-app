...
const systemPrompt = `You are a utility that extracts structured study intent from a user message. Return only valid JSON with exactly two fields: subject (string) and concept (string). If the message is not about studying a concept, respond with {"subject":"","concept":""}. Do not return any explanation or extra text.`;
